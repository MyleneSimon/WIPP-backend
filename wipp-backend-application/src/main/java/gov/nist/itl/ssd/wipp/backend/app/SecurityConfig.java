...
//					.access(new WebExpressionAuthorizationManager("hasRole('admin') or @pyramidSecurity.checkAuthorize(#pyramidId, false)"))
	...
	public WebSecurityCustomizer webSecurityCustomizer() {
		return (web) -> web
                .ignoring().requestMatchers(HttpMethod.POST, CoreConfig.BASE_URI + "/workflows/{workflowId}/exit")
                .and()
                .ignoring().requestMatchers(HttpMethod.POST, CoreConfig.BASE_URI + "/cvatWebhookReceiver");
	}
