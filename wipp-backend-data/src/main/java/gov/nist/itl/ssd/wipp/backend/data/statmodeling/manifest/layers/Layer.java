...
import gov.nist.itl.ssd.wipp.backend.data.visualization.manifest.layers.BaseUrlManualRefDeserializer;
import gov.nist.itl.ssd.wipp.backend.data.visualization.manifest.layers.BaseUrlManualRefSerializer;
...
public class Layer {
	...
	private ColonyFeatures colonyFeatures;
	...
	public ColonyFeatures getColonyFeatures() {
		return colonyFeatures;
	}

	public void setColonyFeatures(ColonyFeatures colonyFeatures) {
		this.colonyFeatures = colonyFeatures;
	}
